...
namespace ClickAndTravelSearchEngine
{
    ...
    public class json_handler : JsonRpcHandler
    {
        ...
        {
            try{
                return (this.search_engine.HotelGetPenalties(search_id, hotel_id, jsonArrayToIntArray(variant_ids)));
            }
            catch(Exception ex)
            {
        ...
        {
            return (this.search_engine.HotelVerify(search_id, hotel_id, jsonArrayToIntArray( variant_ids)));
        }
        ...
        public object tour_get_tour_variant_penalties(string search_id, int tour_id, int variant_id)
        {
        ...
        public object tour_verify_variant(string search_id, int tour_id, int variant_id)
        {
